...
class BtcTradingEnv:  # custom env
    def __init__(self, initial_account=1e6, max_stock=1e2, \
        ...
        '''env information'''
        self.env_name = 'BtcTradingEnv-v3'
        self.state_dim = 14
        self.action_dim = 3
        self.if_discrete = True
        self.target_reward = 1.04  
    ...
    def step(self, action) -> (np.ndarray, float, bool, None):
        ...
        self.gamma_return = self.gamma_return * 0.995 + reward  
        if done:
    ...
    def draw_cumulative_return(self, _torch) -> list:
        ...
        agent = AgentDQN()
        net_dim = 2 ** 9
        cwd = './AgentDQN/BtcTradingEnv-v3_0'
